  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-100 to-white py-12 px-4">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-8 mx-auto">
        ...
        <div class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-red-100 dark:bg-red-900/20 mb-4">
          <svg class="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-width="2"
              d="M9 12h6m2 5H7a2 2 0 01-2-2V7a2 2 0 012-2h8l4 4v4a2 2 0 01-2 2z"
            ></path>
          </svg>
        </div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Developer Registration</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-2">Create your developer account</p>
      </div>
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        ...
        <div>
          <label for="experience" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Experience Level</label>
          <select
            id="experience"
        ...
        >
          <span v-if="!loading">Create Developer Account</span>
