<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-100 to-white flex items-center justify-center p-4">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-8">
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-gray-600 dark:text-gray-400">
          ...
          <router-link to="/register" class="text-red-600 dark:text-red-400 hover:underline font-medium">
            Sign up
          </router-link>
        </p>
      </div>
